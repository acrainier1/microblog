...
class KanjiData(db.Model):
    ...
    Radical4 = db.Column(db.String(32, collation='NOCASE'))
    Onyomi_Reading1 = db.Column(db.String(32, collation='NOCASE'))
    Onyomi_Reading2 = db.Column(db.String(32, collation='NOCASE'))
    Kunyomi_Reading1 = db.Column(db.String(32, collation='NOCASE'))
    Kunyomi_Reading2 = db.Column(db.String(32, collation='NOCASE'))
