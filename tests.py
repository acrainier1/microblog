...
class UserModelCase(unittest.TestCase):
    ...
    def test_follow_posts(self):
        ...
        self.assertEqual(f1, [p2, p4, p1])  # [susan's, david's, self's]
        self.assertEqual(f2, [p2, p3])      # [self's, mary's]
        self.assertEqual(f3, [p3, p4])      # [self's, david's]
        self.assertEqual(f4, [p4])          # [self's]
